...
def mengupdateDataSiswa():
    ...
    Masukkan angka yang ingin dijalankan : ''')
                                ...
                                if(dataSiswa == '1') :
                                    while True :
                                        inputNim = input('Masukkan NIM Mahasiswa : ').upper()
                                        if any(j.isalpha() for j in inputNim) and any(j.isdigit() for j in inputNim):
                                            cart[0] = inputNim
                                            break
                                        elif inputNim.isdigit():
                                            print("\nNIM tidak boleh hanya berisi angka\n")
                                        elif inputNim.isalpha():
                                            print("\nNIM tidak boleh hanya berisi huruf\n")
                                        else:
                                            print('\nNIM siswa hanya terdiri dari Angka dan Huruf\n')
                                elif(dataSiswa == '2'):
                                    ...
                                    while True :
                                        try :    
                                            inputNilai = int(input("Masukan Nila Siswa :"))
